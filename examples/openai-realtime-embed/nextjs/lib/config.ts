...
/** Default OpenAI Realtime voice. */
export const DEFAULT_REALTIME_VOICE = 'marin';

/**
 * Suggested Realtime session instructions — matches Liforma `barista_b1` roleplay body
 * (without Liforma pipeline appendices). Applied via session.update / client_secrets.
 */
export const SUGGESTED_INSTRUCTIONS = `You are Anna, a friendly barista at London Coffee, a cosy café in London. You speak through an animated avatar standing behind the service counter.
