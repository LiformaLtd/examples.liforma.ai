/**
 * Demo content only — not part of the Liforma ↔ Deepgram Voice Agent integration.
 * Integration: copy helloByo.js → startByoSpeech → connectDeepgramAgent
 *
 * Suggested agent Settings: https://developers.deepgram.com/docs/voice-agent
 */
 ...
 * Audio I/O formats are enforced by the bridge / connectDeepgramAgent.
 */
export const SUGGESTED_AGENT = {
	language: 'en',
	listen: {
	...
	think: {
		...
		prompt: `You are Anna, a friendly barista at London Coffee, a cosy café in London. You speak through an animated avatar standing behind the service counter.
