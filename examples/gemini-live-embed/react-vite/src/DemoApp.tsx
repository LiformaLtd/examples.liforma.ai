				...
				<section className="demo-workspace" aria-label="Gemini Live embed">
					...
					<div className="demo-control-card">
						...
						<p className="demo-hint">
							API keys stay on the server — this demo uses a same-origin WS proxy that injects Gemini Live <code>setup</code>. Model / system instruction are set via <code>GEMINI_LIVE_*</code> env on the proxy. See the{' '}
							<a
